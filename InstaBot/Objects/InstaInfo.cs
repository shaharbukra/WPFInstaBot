...
namespace InstaBot.Objects
{
    ...
    public static  class InstaInfo
    {
        ...
        //public static string ApiUrl => "https://i.instagram.com/api/v2/";
        ...
        public static int NumberOfActionsPerTag = 10;
        ...
        //public static string TagsList { get; set; } = "ballerina,dance, ballet, pointe, ig_israel,israel,ballerinaproject_,ballerina,ballerinaproject,insta_global,ריקוד,בלט,מחול,בוקרטוב,ישראל,בוקר";
        public static string TagsList { get; set; } = "בוקר,שלישי,בוקרטוב,ישראל,תלאביב,telaviv,israel,igersisrael";
        
        public static string StopWordList { get; set; } = "sex, porno, money, trade, fuck, pussy, war,death,naked,hate";
